...
export default function HomeV1() {
    ...
    const plans = [
        ...
        {
            name: "Profissional ROTA",
            price: "R$ 97",
            period: "/mês",
            description: "Para atletas sérios e comprometidos",
            features: [
                "Tudo do plano Explorador",
                "Acesso prioritário a eventos",
                "Sistema de patentes exclusivo",
                "Analytics avançado de performance",
                "Grupo exclusivo no WhatsApp",
                "Desconto em eventos (até 30%)",
        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
            ...
            <section className="relative h-screen overflow-hidden">
                ...
                >
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/20 border border-amber-500/50 rounded-full mb-6 backdrop-blur-sm"
                    >
                        <Zap className="w-4 h-4 text-amber-400" />
                        <span className="text-sm font-semibold text-amber-300">SEJA EXTRAORDINÁRIO</span>
                    </motion.div>
                    ...
                    >
                        ...
                        <br />
                        <span className="text-amber-400 font-semibold">Esta é a sua hora de brilhar.</span>
                    </motion.p>
                    ...
                    >
                        <button className="group relative px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full font-bold text-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    >
                        <ChevronDown className="w-8 h-8 animate-bounce text-amber-400" />
                    </motion.div>
                </motion.div>
            </section>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, idx) => (
                            ...
                            >
                                <div className="mb-4 inline-flex p-4 bg-gradient-to-br from-amber-500/20 to-orange-600/20 rounded-2xl group-hover:scale-110 transition-transform">
                                    <stat.icon className="w-8 h-8 text-amber-400" />
                                </div>
                                <div className="text-4xl md:text-5xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">
                                    {stat.value}
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-full mb-6">
                                ...
                                <span className="text-sm font-semibold text-amber-400">NOSSA MISSÃO</span>
                            </div>

                            <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight">
                                Transformando
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600"> Vidas </span>
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-full mb-6">
                            ...
                            <span className="text-sm font-semibold text-amber-400">PASSO A PASSO</span>
                        </div>

                        <h2 className="text-5xl md:text-6xl font-black mb-6">
                            Como
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600"> Funciona</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 relative">
                        {/* Linha conectora */}
                        <div className="hidden md:block absolute top-16 left-0 right-0 h-1 bg-gradient-to-r from-amber-500/20 via-orange-500/20 to-red-500/20" />
                        ...
                        {howItWorks.map((item, idx) => (
                            ...
                            >
                                <div className="relative inline-flex mb-6">
                                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center relative z-10">
                                    ...
                                    <div className="absolute -top-2 -right-2 w-12 h-12 bg-black rounded-full flex items-center justify-center border-2 border-amber-500">
                                        <span className="text-xl font-black text-amber-400">{item.step}</span>
                                    </div>
                                </div>
            ...
            <section className="py-32 bg-black relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        <h2 className="text-5xl md:text-6xl font-black mb-6">
                            PRÓXIMOS
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600"> DESAFIOS</span>
                        </h2>
                        ...
                        {events.map((event, idx) => (
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    <div className="inline-block px-4 py-2 bg-amber-500/90 backdrop-blur-sm rounded-full text-xs font-black mb-4">
                                        {event.status}
                                    </div>

                                    <h3 className="text-3xl font-black mb-3 group-hover:text-amber-400 transition-colors">
                                        {event.title}
                                    </h3>
                                    ...
                                    <button className="w-full py-3 bg-white/10 backdrop-blur-sm border border-white/30 rounded-full font-bold group-hover:bg-amber-500 group-hover:border-amber-500 transition-all">
                                        INSCREVER-SE
                                    </button>
                                </div>
                            </motion.div>
            ...
            <section className="py-32 bg-gradient-to-b from-black to-gray-900">
                <div className="container mx-auto px-6">
                    ...
                    >
                        MOMENTOS QUE
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600"> INSPIRAM</span>
                    </motion.h2>
            ...
            <section className="py-32 bg-black relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        VOZES DO
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600"> MOVIMENTO</span>
                    </motion.h2>
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-12">
                                    <div className="relative w-64 h-64 rounded-full overflow-hidden flex-shrink-0">
                                        <Image
                                            ...
                                            className="object-cover"
                                        />
                                        <div className="absolute inset-0 ring-4 ring-amber-500/50 ring-offset-4 ring-offset-black rounded-full" />
                                    </div>
                                ...
                                <ul className="space-y-4 mb-8">
                                    {plan.features.map((feature, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <CheckCircle2 className={`w-5 h-5 flex-shrink-0 mt-0.5 ${plan.highlighted ? 'text-white' : 'text-amber-400'
                                                }`} />
            ...
            {/* PARCEIROS */}
            <section className="py-24 bg-gradient-to-b from-black to-gray-900 border-y border-gray-800">
                <div className="container mx-auto px-6">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <h3 className="text-2xl font-black text-gray-400 mb-8">PARCEIROS QUE CONFIAM</h3>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-6 gap-8">
                        {partners.map((partner, idx) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: idx * 0.1 }}
                                className="flex flex-col items-center justify-center p-6 bg-gray-800/30 rounded-2xl hover:bg-gray-800/50 transition-colors group cursor-pointer"
                            >
                                <div className="text-5xl mb-2 group-hover:scale-110 transition-transform">
                                    {partner.logo}
                                </div>
                                <div className="text-sm font-bold text-gray-500 group-hover:text-amber-400 transition-colors">
                                    {partner.name}
                                </div>
                            </motion.div>
                        ))}
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
                            Sua transformação começa com um único passo.
                            <br />
                            <span className="text-amber-400 font-semibold">Dê esse passo hoje.</span>
                        </p>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                ...
                                <li><a href="#" className="hover:text-amber-400 transition-colors">Comunidade</a></li>
                                <li><a href="#" className="hover:text-amber-400 transition-colors">Blog</a></li>
                            </ul>
                        </div>

                        <div>
                            <h4 className="font-black mb-4">SUPORTE</h4>
                            <ul className="space-y-2 text-sm text-gray-400">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-gray-400">
                                <li className="flex items-center gap-2">
                                    ...
                                    <a href="mailto:contato@rota.com" className="hover:text-amber-400 transition-colors">
                                        contato@rota.com
                                    </a>
                                </li>
                                <li className="flex items-center gap-2">
                                    <Phone className="w-4 h-4 text-amber-400" />
                                    <a href="tel:+5511999999999" className="hover:text-amber-400 transition-colors">
                                        (11) 99999-9999
                                    </a>
                                </li>
                                <li className="flex items-start gap-2">
                                    <MapPinned className="w-4 h-4 text-amber-400 mt-1" />
