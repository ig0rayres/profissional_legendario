...
export default function HomeV5() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
            {/* HERO CINEMATOGRÁFICO - TEMA CLARO */}
            <section className="relative h-screen overflow-hidden">
                ...
                >
                    <Image
                        ...
                        priority
                    />
                    {/* Overlay escurecido para dar contraste mantendo vivacidade */}
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-white">SEJA EXTRAORDINÁRIO</span>
                    </motion.div>
                    ...
                    >
                        DESAFIE SEUS
                        <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E4D40] via-[#2d7a65] to-[#3fa889]">
                            LIMITES
                        </span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-gray-100 max-w-3xl mb-12 leading-relaxed"
                    >
                        Junte-se a mais de 12 mil atletas que transformaram o impossível em conquista.
                        <br />
                        Esta é a sua hora de <span className="text-[#CC5500] font-bold">brilhar</span>.
                    </motion.p>
                    ...
                    >
                        <button className="group relative px-8 py-4 bg-gradient-to-r from-[#1E4D40] to-[#2d7a65] text-white rounded-full font-bold text-lg overflow-hidden hover:scale-105 transition-transform shadow-lg">
                            <span className="relative z-10">COMEÇAR JORNADA</span>
                            <div className="absolute inset-0 bg-gradient-to-r from-[#2d7a65] to-[#3fa889] opacity-0 group-hover:opacity-100 transition-opacity" />
                        </button>

                        <button className="group px-8 py-4 border-2 border-white text-white rounded-full font-bold text-lg hover:bg-[#CC5500] hover:border-[#CC5500] transition-all flex items-center gap-2 justify-center">
                            <Play className="w-5 h-5 text-[#CC5500] group-hover:text-white transition-colors" />
                            VER HISTÓRIA
                        </button>
                    </motion.div>
                    ...
                    >
                        <ChevronDown className="w-8 h-8 animate-bounce text-[#CC5500]" />
                    </motion.div>
                </motion.div>
            </section>

            {/* STATS BANNER - TEMA CLARO */}
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, idx) => (
                            ...
                            >
                                <div className="mb-4 inline-flex p-4 bg-[#1E4D40]/10 rounded-2xl group-hover:scale-110 group-hover:bg-[#1E4D40]/20 transition-all">
                                    <stat.icon className="w-8 h-8 text-[#1E4D40]" />
                                </div>
                                <div className="text-4xl md:text-5xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#1E4D40] to-[#2d7a65]">
                                    {stat.value}
                                </div>
            ...
            {/* SOBRE / MISSÃO - TEMA CLARO */}
            <section className="py-32 bg-white relative overflow-hidden">
                <div className="absolute inset-0">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#1E4D40]/5 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#1E4D40]/10 border border-[#1E4D40]/20 rounded-full mb-6">
                                <Heart className="w-4 h-4 text-[#1E4D40]" />
                                <span className="text-sm font-semibold text-[#1E4D40]">NOSSA MISSÃO</span>
                            </div>

                            <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight text-gray-900">
                                Transformando
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E4D40] to-[#3fa889]"> Vidas </span>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold mb-1 text-gray-900">Eventos Épicos</div>
                                        <div className="text-sm text-gray-600">Experiências inesquecíveis</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-[#1E4D40] flex-shrink-0 mt-1" />
                                    <div>
                                        <div className="font-bold mb-1 text-gray-900">Comunidade Ativa</div>
                                        <div className="text-sm text-gray-600">12.4K+ atletas conectados</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-[#1E4D40] flex-shrink-0 mt-1" />
                                    <div>
                                        <div className="font-bold mb-1 text-gray-900">Segurança Total</div>
                                        <div className="text-sm text-gray-600">Equipes especializadas</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-[#1E4D40] flex-shrink-0 mt-1" />
                                    <div>
                                        <div className="font-bold mb-1 text-gray-900">Resultados Reais</div>
                                        <div className="text-sm text-gray-600">45.9K conquistas</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="relative h-64 rounded-2xl overflow-hidden mt-8 shadow-lg">
                                    <Image
            ...
            <section className="py-32 bg-gradient-to-b from-white to-gray-50">
                <div className="container mx-auto px-6">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#1E4D40]/10 border border-[#1E4D40]/20 rounded-full mb-6">
                            <Rocket className="w-4 h-4 text-[#1E4D40]" />
                            <span className="text-sm font-semibold text-[#1E4D40]">PASSO A PASSO</span>
                        </div>

                        <h2 className="text-5xl md:text-6xl font-black mb-6 text-gray-900">
                            Como
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E4D40] to-[#3fa889]"> Funciona</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 relative">
                        {/* Linha conectora */}
                        <div className="hidden md:block absolute top-16 left-0 right-0 h-1 bg-[#1E4D40]/20" />
                        ...
                        {howItWorks.map((item, idx) => (
                            ...
                            >
                                <div className="relative inline-flex mb-6">
                                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#1E4D40] to-[#2d7a65] flex items-center justify-center relative z-10 shadow-xl">
                                        <item.icon className="w-12 h-12 text-white" />
                                    </div>
                                    <div className="absolute -top-2 -right-2 w-12 h-12 bg-white rounded-full flex items-center justify-center border-2 border-[#1E4D40] shadow-lg">
                                        <span className="text-xl font-black text-[#1E4D40]">{item.step}</span>
                                    </div>
                                </div>
            ...
            <section className="py-32 bg-gradient-to-b from-gray-50 to-white">
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-5xl md:text-6xl font-black mb-6 text-gray-900">
                            ESCOLHA SEU
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E4D40] to-[#3fa889]"> PLANO</span>
                        </h2>
                        ...
                        {plans.map((plan, idx) => (
                            <motion.div
                                ...
                                className={`relative rounded-3xl p-8 ${plan.highlighted
                                    ? 'bg-gradient-to-br from-[#1E4D40] to-[#2d7a65] scale-105 shadow-2xl'
                                    : 'bg-gray-50 border-2 border-gray-200 shadow-lg'
                                    }`}
                            >
                                {plan.highlighted && (
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 bg-[#3fa889] text-white rounded-full text-sm font-black shadow-lg">
                                        MAIS POPULAR
                                    </div>
                                )}

                                <div className="text-center mb-8">
                                    <h3 className={`text-2xl font-black mb-2 ${plan.highlighted ? 'text-white' : 'text-gray-900'}`}>
                                        {plan.name}
                                    </h3>
                                ...
                                <ul className="space-y-4 mb-8">
                                    {plan.features.map((feature, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <CheckCircle2 className={`w-5 h-5 flex-shrink-0 mt-0.5 ${plan.highlighted ? 'text-[#4dbf9a]' : 'text-[#1E4D40]'
                                                }`} />
                                ...
                                <button className={`w-full py-4 rounded-full font-bold transition-all shadow-lg ${plan.highlighted
                                    ? 'bg-white text-[#1E4D40] hover:bg-gray-100'
                                    : 'bg-gradient-to-r from-[#1E4D40] to-[#2d7a65] text-white hover:scale-105'
                                    }`}>
                                    {plan.cta}
                                </button>
                            </motion.div>
            ...
            <footer className="bg-gray-100 py-16 border-t border-gray-200">
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div>
                            <h4 className="text-xl font-black mb-6 text-[#1E4D40]">ROTA BUSINESS</h4>
                        ...
                        <div>
                            <h5 className="font-bold mb-4 text-gray-900">NAVEGAÇÃO</h5>
                            <ul className="space-y-2 text-gray-600 text-sm">
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Sobre Nós</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Eventos</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Comunidade</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Blog</a></li>
                            </ul>
                        </div>
                        <div>
                            <h5 className="font-bold mb-4 text-gray-900">SUPORTE</h5>
                            <ul className="space-y-2 text-gray-600 text-sm">
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">FAQ</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Contato</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Termos de Uso</a></li>
                                <li><a href="#" className="hover:text-[#1E4D40] transition-colors">Privacidade</a></li>
                            </ul>
                        </div>
                        <div>
                            <h5 className="font-bold mb-4 text-gray-900">REDES SOCIAIS</h5>
                            <div className="flex gap-4">
                                <a href="#" className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-[#1E4D40] hover:text-white transition-all">
