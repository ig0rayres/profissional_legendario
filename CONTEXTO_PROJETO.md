...
*Última atualização: 21/01/2026 - 18:50*
...
- **URL:** https://rotabusinessclub.vercel.app
- **Domínio:** rotabusinessclub.com.br (configurar CNAME)
- **Hospedagem:** Vercel
- **DNS:** Cloudflare
...
### 🚧 Pendentes:
1. **Domínio customizado** - CNAME Cloudflare → Vercel
2. **Emails de produção** - Configurar Resend + Supabase SMTP
3. **Stripe** - Gateway de pagamento
4. **Marketplace** - Produtos/serviços
5. **Eventos** - Criação e inscrições
...
- `docs/GUIA_DEPLOY_VERCEL.md` - **Guia completo de deploy** (erros, soluções, checklist)
- `docs/RESUMO_2026-01-21.md` - Sessão de deploy (17 commits, 3 horas)
