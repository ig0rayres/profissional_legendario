...
export function ConfraternityStats({ userId, isOwnProfile = false }: ConfraternityStatsProps) {
    ...
    return (
        <Card className="border-primary/20 bg-primary/5 shadow-lg shadow-black/10 hover:shadow-xl transition-shadow duration-300">
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="relative flex-shrink-0">
                                        <div className="w-12 h-12 rounded-full border-2 border-primary/20 bg-primary/10 flex items-center justify-center overflow-hidden">
