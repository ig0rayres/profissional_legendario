...
export function RotaValenteV1({
    ...
    return (
        <Card className={cn(
            ...
            <div
                className="absolute inset-0 bg-gradient-to-r from-[#1E4D40] to-[#2E6B54] transition-all duration-[2000ms] ease-out"
                ...
                <div className="flex items-center justify-between gap-4 mb-4">
                    ...
                    <div className="flex-1 flex flex-col items-center">
                        <div className="w-full h-3 bg-black/30 rounded-full overflow-hidden border border-white/10">
                            <div
                                className="h-full bg-gradient-to-r from-[#D4742C] to-[#F97316] transition-all duration-[2000ms] ease-out rounded-full"
                                style={{ width: `${progress}%` }}
                            />
                        </div>
