...
function getActivityIcon(actionType: string) {
    const icons: Record<string, any> = {
        ...
        confraternity_invite_sent: Users,
        confraternity_invite_accepted: Users,
        confraternity_completed: Users,
        confraternity_confirmed: Users,
        confraternity_testimonial: MessageCircle,
        confraternity_photos: Camera,
